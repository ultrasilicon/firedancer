...
class GeyserServiceImpl final : public geyser::Geyser::CallbackService{
  ...
  public:
    ...
    static ::geyser::SubscribeUpdateBlock * startUpdateBlock( fd_replay_notif_msg_t * msg );
    static void addAcct(::geyser::SubscribeUpdateBlock * blk, ulong slot, fd_pubkey_t * key, fd_account_meta_t * meta, const uchar * val, ulong val_sz) ;
