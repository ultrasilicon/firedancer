...
$(call make-bin,fd_grpc_geyser,geyser_server geys_methods geys_filter geys_fd_loop geys_history geyser.grpc.pb geyser.pb solana-storage.pb,fd_discof fd_disco fd_flamenco fd_reedsol fd_funk fd_tango fd_choreo fd_waltz fd_ballet fd_util,$(SECP256K1_LIBS))
